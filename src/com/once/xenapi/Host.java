...
//	}
	...
	public static void setHA(Connection c, Host host, Boolean value)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "host.set_ha";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
	...
	public static Boolean getHA(Connection c, Host host)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "host.get_ha";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(host)};
		Map response = c.dispatch(method_call, method_params);
	...
	public void setPerformanceRecClosed(boolean isPerformanceRecClosedPar) {
		isPerformanceRecClosed = isPerformanceRecClosedPar;
	}
