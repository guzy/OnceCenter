...
public class VM extends XenAPIObject {
	...
	public static class Record implements Types.Record {
		...
		public Map<String, Object> toMap() {
			...
			map.put("crash_dumps",
					this.crashDumps == null ? new LinkedHashSet<Crashdump>()
							: this.crashDumps);
			map.put("VTPMs", this.VTPMs == null ? new LinkedHashSet<VTPM>()
					: this.VTPMs);
			...
			map.put("guest_metrics",
					this.guestMetrics == null ? new VMGuestMetrics(
							"OpaqueRef:NULL") : this.guestMetrics);
			map.put("last_booted_record", this.lastBootedRecord == null ? ""
					: this.lastBootedRecord);
			map.put("recommendations", this.recommendations == null ? ""
					: this.recommendations);
			map.put("xenstore_data",
					this.xenstoreData == null ? new HashMap<String, String>()
							: this.xenstoreData);
			map.put("ha_always_run", this.haAlwaysRun == null ? false
					: this.haAlwaysRun);
			map.put("ha_restart_priority", this.haRestartPriority == null ? ""
					: this.haRestartPriority);
			map.put("is_a_snapshot", this.isASnapshot == null ? false
					: this.isASnapshot);
			map.put("snapshot_of", this.snapshotOf == null ? new VM(
					"OpaqueRef:NULL") : this.snapshotOf);
			map.put("snapshots",
					this.snapshots == null ? new LinkedHashSet<VM>()
							: this.snapshots);
			map.put("snapshot_time", this.snapshotTime == null ? new Date(0)
					: this.snapshotTime);
			map.put("transportable_snapshot_id",
					this.transportableSnapshotId == null ? ""
							: this.transportableSnapshotId);
			map.put("blobs", this.blobs == null ? new HashMap<String, Blob>()
					: this.blobs);
			map.put("tags", this.tags == null ? new LinkedHashSet<String>()
					: this.tags);
			map.put("blocked_operations",
					this.blockedOperations == null ? new HashMap<Types.VmOperations, String>()
							: this.blockedOperations);
			map.put("snapshot_info",
					this.snapshotInfo == null ? new HashMap<String, String>()
							: this.snapshotInfo);
			map.put("snapshot_metadata", this.snapshotMetadata == null ? ""
					: this.snapshotMetadata);
			map.put("parent", this.parent == null ? new VM("OpaqueRef:NULL")
					: this.parent);
			map.put("children", this.children == null ? new LinkedHashSet<VM>()
					: this.children);
			map.put("bios_strings",
					this.biosStrings == null ? new HashMap<String, String>()
							: this.biosStrings);
			map.put("is_snapshot_from_vmpp",
					this.isSnapshotFromVmpp == null ? false
							: this.isSnapshotFromVmpp);
			// map.put("appliance", this.appliance == null ? new VMAppliance(
			// "OpaqueRef:NULL") : this.appliance);
			map.put("start_delay", this.startDelay == null ? 0
					: this.startDelay);
			map.put("shutdown_delay", this.shutdownDelay == null ? 0
					: this.shutdownDelay);
			map.put("order", this.order == null ? 0 : this.order);
			map.put("VGPUs", this.VGPUs == null ? new LinkedHashSet<VGPU>()
					: this.VGPUs);
			map.put("attached_PCIs",
					this.attachedPCIs == null ? new LinkedHashSet<PCI>()
							: this.attachedPCIs);
		...
		/**
		 * marshalled value containing VM record at time of last boot, updated
		 * dynamically to reflect the runtime state of the domain
		 */
		public String lastBootedRecord;
		/**
		 * An XML specification of recommended values and ranges for properties
		 * of this VM
		 */
		...
		/**
		 * if true then the system will attempt to keep the VM running as much
		 * as possible.
		 */
		public Boolean haAlwaysRun;
		/**
		 * has possible values: "best-effort" meaning
		 * "try to restart this VM if possible but don't consider the Pool to be overcommitted if this is not possible"
		 * ; "restart" meaning "this VM should be restarted"; "" meaning
		...
		/**
		 * List of operations which have been explicitly blocked and an error
		 * code
		 */
		...
		/**
		 * The delay to wait before proceeding to the next order in the startup
		 * sequence (seconds)
		 */
		public Long startDelay;
		/**
		 * The delay to wait before proceeding to the next order in the shutdown
		 * sequence (seconds)
		 */
		public Long shutdownDelay;
		/**
		 * The point in the startup or shutdown sequence at which this VM will
		 * be started
		 */
		public Long order;
		/**
	 ...
	 * @return Task
	 */
	public static Task createAsync(Connection c, VM.Record record)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 */
	public static VM create(Connection c, VM.Record record)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	...
	public static Task createFromSxpAsync(Connection c, String path)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "Async.VM.create_from_sxp";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
	 ...
	 * @return value of the field
	 */
	// public Long getVCPUsAtStartup(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
	public Set<VTPM> getVTPMs(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	...
	// * @return value of the field
	// */
	// public Set<VM> getSnapshots(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException {
	...
	public void setSnapshotPolicy(Connection c, String period,
	 ...
	 * @return value of the field
	 */
	public String getSnapshotMetadata(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
	public VM getParent(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
	public Set<VM> getChildren(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
	// public VMAppliance getAppliance(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
	public Long getStartDelay(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
	public Long getShutdownDelay(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
	public Set<VGPU> getVGPUs(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
	public Set<PCI> getAttachedPCIs(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 *            New value to set
	 */
	// public void setAffinity(Connection c, Host affinity)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	// String method_call = "VM.set_affinity";
	// String session = c.getSessionReference();
	// Object[] method_params = { Marshalling.toXMLRPC(session),
	// Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(affinity) };
	// Map response = c.dispatch(method_call, method_params);
	// return;
	// }
	 ...
	 *            New value to set
	 */
	public void setPVBootloader(Connection c, String bootloader)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VM.set_PV_bootloader";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref),
				Marshalling.toXMLRPC(bootloader) };
		Map response = c.dispatch(method_call, method_params);
		return;
	}
	 ...
	 *            New value to set
	 */
	public void setPVKernel(Connection c, String kernel)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VM.set_PV_kernel";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(kernel) };
		Map response = c.dispatch(method_call, method_params);
		return;
	}
	 ...
	 *            New value to set
	 */
	public void setPVRamdisk(Connection c, String ramdisk)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VM.set_PV_ramdisk";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(ramdisk) };
		Map response = c.dispatch(method_call, method_params);
		return;
	}
	 ...
	 *            New value to set
	 */
	public void setPVArgs(Connection c, String args) throws BadServerResponse,
			XenAPIException, XmlRpcException {
		String method_call = "VM.set_PV_args";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(args) };
		Map response = c.dispatch(method_call, method_params);
		return;
	}
	 ...
	 * 
	 * @param bootloaderArgs
	 *            New value to set
	 */
	public void setPVBootloaderArgs(Connection c, String bootloaderArgs)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VM.set_PV_bootloader_args";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref),
				Marshalling.toXMLRPC(bootloaderArgs) };
		Map response = c.dispatch(method_call, method_params);
		return;
	}
	 ...
	 *            New value to set
	 */
	public void setPVLegacyArgs(Connection c, String legacyArgs)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VM.set_PV_legacy_args";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref),
				Marshalling.toXMLRPC(legacyArgs) };
		Map response = c.dispatch(method_call, method_params);
		return;
	}
	 ...
	 */
	@Deprecated
	public void setPCIBus(Connection c, String PCIBus)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VM.set_PCI_bus";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(PCIBus) };
		Map response = c.dispatch(method_call, method_params);
		return;
	}
	...
	/**
	 * Change vlan number of VM閿熸枻鎷�add by wufan : 20131015
	 * 
	 */
	 ...
	 *            New value to set
	 */
	public void setRecommendations(Connection c, String recommendations)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VM.set_recommendations";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref),
				Marshalling.toXMLRPC(recommendations) };
		Map response = c.dispatch(method_call, method_params);
		return;
	}
	...
	public void setBlockedOperations(Connection c,
		...
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref),
				Marshalling.toXMLRPC(blockedOperations) };
		Map response = c.dispatch(method_call, method_params);
		return;
	}

	/**
	 * Add the given key-value pair to the blocked_operations field of the given
	 * VM.
	 * 
	 * @param key
	 *            Key to add
	 ...
	 *            Value to add
	 */
	public void addToBlockedOperations(Connection c, Types.VmOperations key,
	 ...
	 *            Key to remove
	 */
	public void removeFromBlockedOperations(Connection c, Types.VmOperations key)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 *            New value to set
	 */
	public void setSuspendSR(Connection c, SR suspendSR)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VM.set_suspend_SR";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(suspendSR) };
		Map response = c.dispatch(method_call, method_params);
		return;
	}
	 ...
	 * @return Task
	 */
	// public Task snapshotAsync(Connection c, String newName)
	// throws BadServerResponse, XenAPIException, XmlRpcException,
	 ...
	 * @return Task
	 */
	// public Task snapshotWithQuiesceAsync(Connection c, String newName)
	// throws BadServerResponse, XenAPIException, XmlRpcException,
	// Types.VmBadPowerState, Types.SrFull, Types.OperationNotAllowed,
	 ...
	 * @return The reference of the newly created VM.
	 */
	public VM snapshotWithQuiesce(Connection c, String newName)
			throws BadServerResponse, XenAPIException, XmlRpcException,
			Types.VmBadPowerState, Types.SrFull, Types.OperationNotAllowed,
			Types.VmSnapshotWithQuiesceFailed,
			Types.VmSnapshotWithQuiesceTimeout,
	 ...
	 * @return Task
	 */
	// public Task createCloneAsync(Connection c, String newName)
	// throws BadServerResponse, XenAPIException, XmlRpcException,
	// Types.VmBadPowerState, Types.SrFull, Types.OperationNotAllowed {
	 ...
	 * @param sr
	 *            An SR to copy all the VM's disks into (if an invalid reference
	 *            then it uses the existing SRs)
	 * @return Task
	 */
	// public Task copyAsync(Connection c, String newName, SR sr)
	// throws BadServerResponse, XenAPIException, XmlRpcException,
	// Types.VmBadPowerState, Types.SrFull, Types.OperationNotAllowed {
	 ...
	 * @return The reference of the newly created VM.
	 */
	public VM copy(Connection c, String newName, SR sr)
			throws BadServerResponse, XenAPIException, XmlRpcException,
			Types.VmBadPowerState, Types.SrFull, Types.OperationNotAllowed {
	 ...
	 * @return Task
	 */
	// public Task revertAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException, Types.VmBadPowerState,
	// Types.OperationNotAllowed, Types.SrFull, Types.VmRevertFailed {
	 ...
	 * 
	 */
	public void revert(Connection c) throws BadServerResponse, XenAPIException,
			XmlRpcException, Types.VmBadPowerState, Types.OperationNotAllowed,
			Types.SrFull, Types.VmRevertFailed {
	 ...
	 * exploits the capabilities of the underlying storage repository in which
	 * the VM's disk images are stored (e.g. Copy on Write) and saves the memory
	 * image as well.
	 * 
	 * @param newName
	 ...
	 * @return Task
	 */
	// public Task checkpointAsync(Connection c, String newName)
	// throws BadServerResponse, XenAPIException, XmlRpcException,
	// Types.VmBadPowerState, Types.SrFull, Types.OperationNotAllowed,
	// Types.VmCheckpointSuspendFailed, Types.VmCheckpointResumeFailed {
	 ...
	 * @return The reference of the newly created VM.
	 */
	public VM checkpoint(Connection c, String newName)
			throws BadServerResponse, XenAPIException, XmlRpcException,
			Types.VmBadPowerState, Types.SrFull, Types.OperationNotAllowed,
			Types.VmCheckpointSuspendFailed, Types.VmCheckpointResumeFailed {
	 ...
	 * @return Task
	 */
	// public Task provisionAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException, Types.VmBadPowerState,
	// Types.SrFull, Types.OperationNotAllowed {
	 ...
	 * 
	 */
	public void provision(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException, Types.VmBadPowerState,
			Types.SrFull, Types.OperationNotAllowed {
	 ...
	 * @return Task
	 */
	// public Task startAsync(Connection c, Boolean startPaused, Boolean force)
	// throws BadServerResponse, XenAPIException, XmlRpcException,
	 ...
	 * @return Task
	 */
	// public Task startOnAsync(Connection c, Host host, Boolean startPaused,
	...
	// Marshalling.toXMLRPC(startPaused), Marshalling.toXMLRPC(force),
	// Marshalling.toXMLRPC(null), Marshalling.toXMLRPC(null),
	// Marshalling.toXMLRPC(null) };
	// Map response = c.dispatch(method_call, method_params);
	// Object result = response.get("Value");
	// return Types.toTask(result);
	 ...
	 * @return Task
	 */
	// public Task pauseAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException, Types.VmBadPowerState,
	// Types.OtherOperationInProgress, Types.OperationNotAllowed,
	// Types.VmIsTemplate {
	 ...
	 * @return Task
	 */
	// public Task unpauseAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException, Types.VmBadPowerState,
	 ...
	 * @return Task
	 */
	// public Task cleanShutdownAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException, Types.VmBadPowerState,
	// Types.OtherOperationInProgress, Types.OperationNotAllowed,
	// Types.VmIsTemplate {
	 ...
	 * @return Task
	 */
	// public Task cleanRebootAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException, Types.VmBadPowerState,
	// Types.OtherOperationInProgress, Types.OperationNotAllowed,
	// Types.VmIsTemplate {
	 ...
	 * @return Task
	 */
	// public Task hardShutdownAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException, Types.VmBadPowerState,
	// Types.OtherOperationInProgress, Types.OperationNotAllowed,
	// Types.VmIsTemplate {
	...
	/**
	 * Reset the power-state of the VM to halted in the database only. (Used to
	 * recover from slave failures in pooling scenarios by resetting the
	 * power-states of VMs running on dead slaves to halted.) This is a
	 * potentially dangerous operation; use with care.
	 * 
	 * @return Task
	 */
	// public Task powerStateResetAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException {
	 ...
	 * 
	 */
	public void powerStateReset(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task hardRebootAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException, Types.VmBadPowerState,
	// Types.OtherOperationInProgress, Types.OperationNotAllowed,
	// Types.VmIsTemplate {
	 ...
	 * @return Task
	 */
	// public Task suspendAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException, Types.VmBadPowerState,
	// Types.OtherOperationInProgress, Types.OperationNotAllowed,
	// Types.VmIsTemplate {
	 ...
	 * @return Task
	 */
	// public Task resumeAsync(Connection c, Boolean startPaused, Boolean force)
	// throws BadServerResponse, XenAPIException, XmlRpcException,
	 ...
	 * @return Task
	 */
	// public Task resumeOnAsync(Connection c, Host host, Boolean startPaused,
	// Boolean force) throws BadServerResponse, XenAPIException,
	// XmlRpcException, Types.VmBadPowerState, Types.OperationNotAllowed,
	// Types.VmIsTemplate {
	 ...
	 * @return Task
	 */
	// public Task poolMigrateAsync(Connection c, Host host,
	// Map<String, String> options) throws BadServerResponse,
	// XenAPIException, XmlRpcException, Types.VmBadPowerState,
	// Types.OtherOperationInProgress, Types.VmIsTemplate,
	// Types.OperationNotAllowed, Types.VmMigrateFailed,
	 ...
	 * @return Task
	 */
	// public Task setVCPUsNumberLiveAsync(Connection c, Long nvcpu)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task addToVCPUsParamsLiveAsync(Connection c, String key, String
	// value)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 *            The value
	 */
	public void setHaRestartPriority(Connection c, String value)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 */
	@Deprecated
	public void setHaAlwaysRun(Connection c, Boolean value)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task setMemoryDynamicRangeAsync(Connection c, Long min, Long max)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task setMemoryStaticRangeAsync(Connection c, Long min, Long max)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task setMemoryLimitsAsync(Connection c, Long staticMin,
	// Long staticMax, Long dynamicMin, Long dynamicMax)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 */
	// @Deprecated
	// public Task setMemoryTargetLiveAsync(Connection c, Long target)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	// String method_call = "Async.VM.set_memory_target_live";
	// String session = c.getSessionReference();
	// Object[] method_params = { Marshalling.toXMLRPC(session),
	// Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(target) };
	// Map response = c.dispatch(method_call, method_params);
	// Object result = response.get("Value");
	// return Types.toTask(result);
	// }
	 ...
	 */
	@Deprecated
	public void setMemoryTargetLive(Connection c, Long target)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 */
	@Deprecated
	public void waitMemoryTargetLive(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task getCooperativeAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException {
	 ...
	 */
	public Boolean getCooperative(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task setShadowMultiplierLiveAsync(Connection c, Double multiplier)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	// String method_call = "Async.VM.set_shadow_multiplier_live";
	// String session = c.getSessionReference();
	// Object[] method_params = { Marshalling.toXMLRPC(session),
	// Marshalling.toXMLRPC(this.ref),
	// Marshalling.toXMLRPC(multiplier) };
	// Map response = c.dispatch(method_call, method_params);
	// Object result = response.get("Value");
	// return Types.toTask(result);
	// }
	 ...
	 *            The new shadow memory multiplier to set
	 */
	public void setShadowMultiplierLive(Connection c, Double multiplier)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task sendSysrqAsync(Connection c, String key)
	// throws BadServerResponse, XenAPIException, XmlRpcException,
	 ...
	 * @return Task
	 */
	// public Task sendTriggerAsync(Connection c, String trigger)
	// throws BadServerResponse, XenAPIException, XmlRpcException,
	// Types.VmBadPowerState {
	 ...
	 * overheads, in the supplied amount of physical memory. If 'exact' is true
	 * then an exact calculation is performed using the VM's current settings.
	 * If 'exact' is false then a more conservative approximation is used
	 * 
	 * @param total
	 *            Total amount of physical RAM to fit within
	 * @param approximate
	 *            If false the limit is calculated with the guest's current
	 *            exact configuration. Otherwise a more approximate calculation
	 *            is performed
	 * @return Task
	 */
	// public Task maximiseMemoryAsync(Connection c, Long total,
	// Boolean approximate) throws BadServerResponse, XenAPIException,
	// XmlRpcException {
	// String method_call = "Async.VM.maximise_memory";
	// String session = c.getSessionReference();
	// Object[] method_params = { Marshalling.toXMLRPC(session),
	// Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(total),
	// Marshalling.toXMLRPC(approximate) };
	// Map response = c.dispatch(method_call, method_params);
	// Object result = response.get("Value");
	// return Types.toTask(result);
	// }
	...
	/**
	 * Returns a record describing the VM's dynamic state, initialised when the
	 * VM boots and updated to reflect runtime configuration changes e.g. CPU
	 * hotplug
	 * 
	 * @return A record describing the VM
	 */
	public VM.Record getBootRecord(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	...
	/**
	 * Check to see whether this operation is acceptable in the current state of
	 * the system, raising an error if the operation is invalid for some reason
	 * 
	 * @param op
	 *            proposed operation
	 * @return Task
	...
	// String session = c.getSessionReference();
	// Object[] method_params = { Marshalling.toXMLRPC(session),
	// Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(op) };
	// Map response = c.dispatch(method_call, method_params);
	// Object result = response.get("Value");
	// return Types.toTask(result);
	// }
	 ...
	 *            proposed operation
	 */
	public void assertOperationValid(Connection c, Types.VmOperations op)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * 
	 */
	public void updateAllowedOperations(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task getPossibleHostsAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException {
	 ...
	 */
	public Set<Host> getPossibleHosts(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task assertCanBootHereAsync(Connection c, Host host)
	// throws BadServerResponse, XenAPIException, XmlRpcException,
	// Types.HostNotEnoughFreeMemory, Types.VmRequiresSr,
	 ...
	 *            The host
	 */
	public void assertCanBootHere(Connection c, Host host)
			throws BadServerResponse, XenAPIException, XmlRpcException,
			Types.HostNotEnoughFreeMemory, Types.VmRequiresSr,
			Types.VmHostIncompatibleVersion {
	 ...
	 * @return Task
	 */
	// public Task assertAgileAsync(Connection c) throws BadServerResponse,
	// XenAPIException, XmlRpcException {
	 ...
	 * 
	 */
	public void assertAgile(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * with an error if the VM cannot boot there.
	 * 
	 * @return The potential hosts and their corresponding recommendations or
	 *         errors
	 */
	 ...
	 * @return Task
	 */
	// public Task copyBiosStringsAsync(Connection c, Host host)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 *            The host to copy the BIOS strings from
	 */
	public void copyBiosStrings(Connection c, Host host)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task setStartDelayAsync(Connection c, Long value)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 *            This VM's start delay in seconds
	 */
	public void setStartDelay(Connection c, Long value)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task setShutdownDelayAsync(Connection c, Long value)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 *            This VM's shutdown delay in seconds
	 */
	public void setShutdownDelay(Connection c, Long value)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task setOrderAsync(Connection c, Long value)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	public Task setSuspendVDIAsync(Connection c, VDI value)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 *            The suspend VDI uuid
	 */
	public void setSuspendVDI(Connection c, VDI value)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	public Task assertCanBeRecoveredAsync(Connection c, Session sessionTo)
			throws BadServerResponse, XenAPIException, XmlRpcException,
			Types.VmIsPartOfAnAppliance, Types.VmRequiresSr {
		String method_call = "Async.VM.assert_can_be_recovered";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(sessionTo) };
		Map response = c.dispatch(method_call, method_params);
		Object result = response.get("Value");
		return Types.toTask(result);
	}
	 ...
	 *            The session to which the VM is to be recovered.
	 */
	public void assertCanBeRecovered(Connection c, Session sessionTo)
			throws BadServerResponse, XenAPIException, XmlRpcException,
			Types.VmIsPartOfAnAppliance, Types.VmRequiresSr {
	 ...
	 * @return Task
	 */
	public Task recoverAsync(Connection c, Session sessionTo, Boolean force)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "Async.VM.recover";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref),
				Marshalling.toXMLRPC(sessionTo), Marshalling.toXMLRPC(force) };
		Map response = c.dispatch(method_call, method_params);
		Object result = response.get("Value");
		return Types.toTask(result);
	}
	 ...
	 *            Whether the VM should replace newer versions of itself.
	 */
	public void recover(Connection c, Session sessionTo, Boolean force)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return Task
	 */
	// public Task setApplianceAsync(Connection c, VMAppliance value)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 *            The appliance to which this VM should be assigned.
	 */
	// public void setAppliance(Connection c, VMAppliance value)
	// throws BadServerResponse, XenAPIException, XmlRpcException {
	...
	/*
	 * 閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熷壙绛规嫹閿燂拷boot_order涓�cd"閿熸枻鎷风ず閿熸枻鎷风‖閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷�boot_order涓�dc"閿熸枻鎷风ず閿熸帴鐧告嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷�
	 * 閿熸埅浼欐嫹鐘舵�閿熼摪鏀规唻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鍙拷	 */
	...
	/**
	 * Change rate and burst of VM閿熸枻鎷�add by wufan : 20140102 type: "rate": set
	 * rate "burst": set burst
	 */
	public void setRate(Connection c, String type, VIF vif, String value)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
	public String getRate(Connection c, String type, VIF vif_ref)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	...
	/*
	 * 鐠佸墽鐤嗛搹姘珯閺堥缚顔栭梻顔锯�閻╂﹢妾洪柅鐕傜礉 type閿涳拷read 閸滐拷write 閸楁洑缍呴敍锟組B/s
	 */
	public void setIORateLimit(Connection c, String type, String value)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	...
	/*
	 * 閼惧嘲褰囬搹姘珯閺堢瘨O闂勬劙锟�type閿涙ead閸滃瘍rite 閸楁洑缍呴敍姝丅/s
	 */
	public int getIORateLimit(Connection c, String type)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	...
	/*
	 * 濞撳懘娅庨搹姘珯閺堥缚顔栭梻顔锯�閻╂﹢妾洪柅鐕傜礉 type閿涳拷read 閸滐拷write
	 */
	...
	/*
	 * 鐠佸墽鐤嗛搹姘珯閺堝搫鐦戦惍锟� */
	public boolean setPasswd(Connection c, String vm_ip, String newPasswd, String oldPasswd, String type) 
			throws BadServerResponse,
	XenAPIException, XmlRpcException {
		...
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref),
				Marshalling.toXMLRPC(vm_ip),
				Marshalling.toXMLRPC(newPasswd),
				Marshalling.toXMLRPC(oldPasswd),
	...
	// 濡剝婢橀悽鐔稿灇閾忔碍瀚欓張锟�// Map<String,Object> map = (Map<String,Object>) object;
	// map.put("cpuNumber", new Long(1));
	// map.put("memoryValue", new Long(1024)); 閸楁洑缍呮稉绡桞
	// map.put("vlanId", new Long(2));
	// map.put("IOreadLimit", new Long(30)); //閸楁洑缍呴敍姝丅ps
	// map.put("IOwriteLimit", new Long(30)); //閸楁洑缍呴敍姝丅ps
	// map.put("newUuid", new String(""));
	// map.put("passwd", new String(""));
	// map.put("origin_passwd",  new String(""));
	// map.put("IP",  new String(""));
	// map.put("type", new String("linux")); //閹存牞锟�windows"
	...
	/*
	 * if it's a pool, connection is master, and host is in the pool
	 * if not a pool, connection and host must be refer to the same host
	 */
	...
	public Boolean createImage(Connection c, String templateUuid){
		try{
			...
			Object[] method_params = { Marshalling.toXMLRPC(session),
					Marshalling.toXMLRPC(this.ref),
					Marshalling.toXMLRPC(templateName), Marshalling.toXMLRPC(templateUuid)};
			Map response = c.dispatch(method_call, method_params);
			Object result = response.get("Value");
	 ...
	 * @return all lost vms
	 */
	public static Boolean createDataVBD(Connection c, String vm_uuid, String vdi_uuid)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return all lost vms
	 */
	public static Boolean deleteDataVBD(Connection c, String vm_uuid, String vdi_uuid)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * @return vdi.
	 */
	public VDI getSystemVDI(Connection c)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	 ...
	 * 
	 */
	public static VDI cloneSystemVDI(Connection c, String template_uuid, String newuuid)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	...
	/*娴犲丢SO閸掓稑缂撻搹姘珯閺堢尨绱�isoUuid娑撶so鐎电懓绨查惃鍓塪i閻ㄥ増uid閿涳拷	 * storage娑撳搫鐡ㄩ崒銊ф畱鐎瑰綊鍣�閸楁洑缍呮稉绡�婵★拷0G 閸掓瑤绱堕崗銉ュ棘閺侀璐�0
	 * memory娑撳搫鍞寸�妯恒亣鐏忓骏绱濋崡鏇氱秴娑撶瘲B,4G 閸掓瑤绱堕崗銉ュ棘閺侀璐�096 
	 * vcpu娑撶pu娑擃亝鏆�
	 */
	...
	/* 
	 * 閾忔碍瀚欓張鍝勵杻閸旂姳瑕嗛崣锝忕礉娴ｈ法鏁ら弶鈥叉閿涙俺娅勯幏鐔告簚閸忔娊妫撮敍灞芥儊閸掓瑦妫ゅ▔鏇犳晸閺侊拷	 */
