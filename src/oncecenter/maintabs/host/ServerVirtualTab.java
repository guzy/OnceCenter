...
public class ServerVirtualTab extends OnceHostTabItem {
	...
	public ServerVirtualTab(CTabFolder arg0, int arg1, int arg2,
	...
	public boolean Init(){
		...
		chartFrame.setBackground(new java.awt.Color(240, 240, 240));
			...
			if(!display.isDisposed())
			{
				Runnable runnable = new Runnable(){
					...
					public void run() {
						...
						parentFrame.setBackground(new java.awt.Color(240, 240, 240));
...
//						}
						...
						ColorBackground color = new ColorBackground(new java.awt.Color(240, 240, 240));
